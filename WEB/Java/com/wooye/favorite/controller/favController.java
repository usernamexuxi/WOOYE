...
public class favController {
	...
	public ModelAndView Test1(Model model, javax.servlet.http.HttpServletRequest HttpServletRequest, JoinTasteDAO jointasteDAO) {
		String id = HttpServletRequest.getParameter("id");
		...
		mav.addObject("co_list", sb.toString()); // "test1"는 jsp파일에서 받을때 이름,
