...
<body>
	...
	<div class="container shadow-dreamy">
		<p id="conplete">게시글 좋아요가 완료되었습니다.</p>
	    <a href="/getBoard.do?seq=${board.seq}" class="btn" style="float:left; color: #fff; margin-left:40%;">게시글 확인</a>
	    <a href="/boardmain.do" class="btn" style="color: #fff; margin-left:30px;">게시글 목록 가기</a>
    </div>
