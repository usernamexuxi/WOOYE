...
<body>
	...
	<div class="container shadow-dreamy">
		<div id="conplete">댓글 작성 및 수정 완료</div>
		<form action="/getBoard.do?seq=${board.seq}" method="POST" class="gomypage">
			<input type="submit" class="btn" value="댓글 확인"  style="margin-top: 40px; color: #fff;"/>
		</form>
		<form action="/boardmain.do" method="POST" class="gomypage">
			<input type="submit" class="btn" value="게시글 목록 가기"  style="margin-top: 10px; color: #fff;"/>
		</form>
    </div>
