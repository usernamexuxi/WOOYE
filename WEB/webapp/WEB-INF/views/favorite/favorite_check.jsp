...
<body>
	...
	<!-- 옵션 선택하면 추가 되야 함 -->
<div class="container">
	<p class="pname"><span class="colorSpan2">${userName}</span>님 예술 취향 기입하기 : 전에 기입한 취향 삭제 완료</p>
	<form action="/newmyfav_submit.do?id=${userId}" method="POST">
		<div class="mainMid">
		...
		<input class="btn btn-secondary mb-3" onclick="alert('다음 페이지로 넘어갈 때까지 잠시 기다려주세요.');" type="submit" value="취향 기입" style="margin-left:40%; color: #fff;" />
	</form>
</div>
	<!-- footer/ copyright -->
	<footer>
